    ...
    <section id="cases" className="py-24 md:py-32 px-4">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-10"
        >
          <h2 className="text-xs font-mono tracking-[0.4em] uppercase text-primary mb-4">Incident Log</h2>
          <p className="text-2xl md:text-3xl font-serif text-foreground">Recent Incidents</p>
        </motion.div>
        ...
        <div className="space-y-3">
          {recentCases.map((c, i) => (
            <motion.div
              ...
              className="border border-border bg-card rounded-md p-5 transition-all duration-300 hover:border-primary/30 hover:shadow-[0_0_15px_-5px_hsl(var(--primary)/0.1)]"
            >
